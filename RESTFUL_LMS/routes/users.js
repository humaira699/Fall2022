...
//uncomment for simple authentication where username & pwd stored in mongodb
...
// });
//end uncomment:::::::::
// router.post('/login', passport.authenticate('local',{ successRedirect: '/', failureRedirect: '/user'}));
